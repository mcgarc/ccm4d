...
In this section we will extend these ideas to diatomics formed from larger
atoms. We will give an overview of the different orbitals in molecules and the
shape of the electronic potentials that they create.
...
diagram as shown in \myfigref{electronic:fig:HMO}.

\begin{figure}
  % TODO
  \caption{This figure should show the H diagram as can be foudn on the MO
  WIki page.}
  \label{electronic:fig:HMO}
\end{figure}
...
\myfigref{electronic:fig:LiMO}. Again, we can expect these to be formed of a linear
...
\ce{Li}. The MO diagram of \ce{He2} is shown in \myfigref{electronic:fig:HeMO},
...
\end{equation}
%
The resulting orbital energies are plotted in \myfigref{:electronic:fig:Henergies},
...
\begin{figure}
  ...
  length discrepancy.}
  \label{electronic:fig:Henergies}
\end{figure}
...
\begin{figure}
  ...
  \label{electronic:fig:2ndperiod}
\end{figure}

Figure \myfigref{electronic:fig:2ndperiod} shows the MO diagrams for the
...
\myfigref{electronic:fig:N2O2}. MO theory is able to predict the paramagnetism of
...
\subsection{Extension to heteronuclear molecules}
...
\myfigref{electronic:fig:CO}. Oxygen has a higher atomic number, and hence the
...
\subsection{Extension to ionic bonds}

\subsection{Labelling electron states}
...
\subsection{Electronic potential of diatomic molecules}
...
\myfigref{electronic:fig:Henergies}).
...
\ph{Show absorption and fluorseence spectra, e.g. HandW figs 14.7 and 14.8}
