...
bond is negative, so \{Li2+}  is a stable molecule.
...
$\psi_i$ in terms of the atomic orbitals of similar energy $\phi_i$
%
\begin{equation}
...
%
\begin{equation}
  E_\pm(R) = \frac{H_{11}(R) \pm H_{12}(R)}{1 + S(R)} + \frac{e^2}{4 \pi
  \epsilon_0 R}.
\end{equation}
%
